-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\Chilipepper_Labs\Labs\Lab_4\MATLAB\codegen\dc_offset_correction\hdlsrc\dc_offset_pcore_addr_decoder.vhd
...
ARCHITECTURE rtl OF dc_offset_pcore_addr_decoder IS
  ...
  SIGNAL data_in_rssi_low_goal_in         : unsigned(29 DOWNTO 0);  -- ufix30
  SIGNAL decode_sel_rssi_low_goal_in      : std_logic;  -- ufix1
  SIGNAL reg_enb_rssi_low_goal_in         : std_logic;  -- ufix1
  SIGNAL write_reg_rssi_low_goal_in       : unsigned(29 DOWNTO 0);  -- ufix30
  SIGNAL data_in_rssi_high_goal_in        : unsigned(29 DOWNTO 0);  -- ufix30
  SIGNAL decode_sel_rssi_high_goal_in     : std_logic;  -- ufix1
  SIGNAL reg_enb_rssi_high_goal_in        : std_logic;  -- ufix1
  SIGNAL write_reg_rssi_high_goal_in      : unsigned(29 DOWNTO 0);  -- ufix30
  ...
  SIGNAL data_in_gain_in                  : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL decode_sel_gain_in               : std_logic;  -- ufix1
  SIGNAL reg_enb_gain_in                  : std_logic;  -- ufix1
  SIGNAL write_reg_gain_in                : unsigned(5 DOWNTO 0);  -- ufix6
...
BEGIN
  ...
  decode_sel_dir_out <= '1' WHEN addr_sel_unsigned = 69 ELSE
      '0';
  ...
  decode_rd_dir_out <= decode_rd_rssi_out WHEN decode_sel_dir_out = '0' ELSE
      data_in_dir_out;

  data_read <= std_logic_vector(decode_rd_dir_out);
  ...
  data_in_rssi_low_goal_in <= data_write_unsigned(29 DOWNTO 0);
  ...
  BEGIN
    IF reset = '1' THEN
      write_reg_rssi_low_goal_in <= to_unsigned(2#000000000000000000000000000000#, 30);
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  data_in_rssi_high_goal_in <= data_write_unsigned(29 DOWNTO 0);
  ...
  BEGIN
    IF reset = '1' THEN
      write_reg_rssi_high_goal_in <= to_unsigned(2#000000000000000000000000000000#, 30);
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  data_in_gain_in <= data_write_unsigned(5 DOWNTO 0);

  
  decode_sel_gain_in <= '1' WHEN addr_sel_unsigned = 70 ELSE
      '0';

  reg_enb_gain_in <= decode_sel_gain_in AND wr_enb;

  reg_gain_in_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      write_reg_gain_in <= to_unsigned(2#000000#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND reg_enb_gain_in = '1' THEN
        write_reg_gain_in <= data_in_gain_in;
      END IF;
    END IF;
  END PROCESS reg_gain_in_process;


  write_gain_in <= std_logic_vector(write_reg_gain_in);
