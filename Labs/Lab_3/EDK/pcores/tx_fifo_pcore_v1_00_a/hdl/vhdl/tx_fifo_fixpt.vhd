...
-- dbg_head_out                  ce_out        1
-- dbg_tail_out                  ce_out        1
-- dbg_last_queue                ce_out        1
-- dbg_byte_recieved             ce_out        1
-- dbg_handshake                 ce_out        1
-- dbg_byte_out                  ce_out        1
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF tx_fifo_fixpt IS
  ...
  SIGNAL byte_in_unsigned                 : unsigned(8 DOWNTO 0);  -- ufix9
  ...
  SIGNAL dbg_head_out_tmp                 : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL dbg_tail_out_tmp                 : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL dbg_last_queue_tmp               : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL dbg_byte_recieved_1              : std_logic;  -- ufix1
  SIGNAL dbg_byte_recieved_2              : std_logic;  -- ufix1
  SIGNAL tmp_41                           : std_logic;  -- ufix1
  SIGNAL dbg_handshake_1                  : std_logic;  -- ufix1
  SIGNAL dbg_handshake_2                  : std_logic;  -- ufix1
  SIGNAL dbg_byte_out_1                   : unsigned(8 DOWNTO 0);  -- ufix9
...
BEGIN
  ...
  tmp_24 <= byte_in_unsigned(7 DOWNTO 0);
  ...
  BEGIN
    IF reset = '1' THEN
      dbg_head_out_tmp <= to_unsigned(2#00000000000#, 11);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        dbg_head_out_tmp <= tmp_16;
      END IF;
    END IF;
  END PROCESS delayMatch_10_process;


  dbg_head_out <= std_logic_vector(dbg_head_out_tmp);

  delayMatch_11_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      dbg_tail_out_tmp <= to_unsigned(2#00000000000#, 11);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        dbg_tail_out_tmp <= tmp_18;
      END IF;
    END IF;
  END PROCESS delayMatch_11_process;


  dbg_tail_out <= std_logic_vector(dbg_tail_out_tmp);

  delayMatch_12_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      dbg_last_queue_tmp <= to_unsigned(2#000000000#, 9);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        dbg_last_queue_tmp <= byte_in_unsigned;
      END IF;
    END IF;
  END PROCESS delayMatch_12_process;


  dbg_last_queue <= std_logic_vector(dbg_last_queue_tmp);

  dbg_byte_recieved_1 <= tmp_36;

  dbg_byte_recieved_2 <= dbg_byte_recieved_1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        dbg_byte_recieved <= dbg_byte_recieved_2;
      END IF;
    END IF;
  ...
  dbg_handshake_1 <= tmp_41;

  dbg_handshake_2 <= dbg_handshake_1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        dbg_handshake <= dbg_handshake_2;
      END IF;
    END IF;
  END PROCESS delayMatch_14_process;


  dbg_byte_out_1 <= resize(tmp_33, 9);

  dbg_byte_out <= std_logic_vector(dbg_byte_out_1);
