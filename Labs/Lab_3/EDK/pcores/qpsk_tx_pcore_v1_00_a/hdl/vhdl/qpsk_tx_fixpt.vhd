-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\Chilipepper_Labs\Labs\Lab_3\MATLAB\codegen\qpsk_tx\hdlsrc\qpsk_tx_fixpt.vhd
...
BEGIN
  ...
  tmp_30 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_35 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_38 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_42 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_46 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_48 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_66 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_69 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
  ...
  tmp_80 <= '1' WHEN (tx_en_in = '1') AND (tmp_29 = '0') ELSE
      '0';
