...
ARCHITECTURE rtl OF tx_fifo_pcore_addr_decoder IS
  ...
  SIGNAL data_in_byte_in                  : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL decode_sel_byte_in               : std_logic;  -- ufix1
  SIGNAL reg_enb_byte_in                  : std_logic;  -- ufix1
  SIGNAL write_reg_byte_in                : unsigned(8 DOWNTO 0);  -- ufix9
...
BEGIN
  ...
  decode_sel_byte_received <= '1' WHEN addr_sel_unsigned = 67 ELSE
      '0';
  ...
  decode_sel_full <= '1' WHEN addr_sel_unsigned = 68 ELSE
      '0';
  ...
  decode_rd_byte_received <= const_z WHEN decode_sel_byte_received = '0' ELSE
  ...
  decode_sel_store_byte <= '1' WHEN addr_sel_unsigned = 64 ELSE
      '0';
  ...
  data_in_byte_in <= data_write_unsigned(8 DOWNTO 0);

  
  decode_sel_byte_in <= '1' WHEN addr_sel_unsigned = 65 ELSE
      '0';
  ...
  BEGIN
    IF reset = '1' THEN
      write_reg_byte_in <= to_unsigned(2#000000000#, 9);
    ELSIF clk'EVENT AND clk = '1' THEN
