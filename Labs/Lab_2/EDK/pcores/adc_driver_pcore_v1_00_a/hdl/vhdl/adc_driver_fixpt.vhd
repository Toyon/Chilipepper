...
ARCHITECTURE rtl OF adc_driver_fixpt IS
  ...
  SIGNAL p20blinky_cast                   : unsigned(1 DOWNTO 0);  -- ufix2
...
BEGIN
  ...
  tmp_2 <= '1' WHEN rx_iq_sel = '0' ELSE
      '0';

  
  tmp_3 <= '1' WHEN rx_iq_sel = '0' ELSE
      '0';

  
  tmp_4 <= rxd_signed WHEN tmp_3 = '1' ELSE
      q_out_delay;
  ...
  p20blinky_cast <= p20blinky_mul_temp(38 DOWNTO 37);
  blinky_1 <= p20blinky_cast(0);
