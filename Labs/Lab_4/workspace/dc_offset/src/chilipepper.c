...
int Chilipepper_Initialize( void )
{
    ...
    // RX core
    chili_rssi = 			(Xuint32 *)(0x6fc00000 + 0x804); // read
    chili_dir = 			(Xuint32 *)(0x6fc00000 + 0x800); // read
    chili_rssi_high_goal = 	(Xuint32 *)(0x6fc00000 + 0x804); // write
    chili_rssi_low_goal = 	(Xuint32 *)(0x6fc00000 + 0x808); // write
    chili_agc_en = 			(Xuint32 *)(0x6fc00000 + 0x80C); // write
    rx_en =  				(Xuint32 *)(0x6fc00000 + 0x800); // write
#endif
