...
Xuint32 *dac_en;
// rx registers
Xuint32 *chili_rssi, *chili_percent_full, *chili_dir, *chili_rssi_high_goal, *chili_rssi_low_goal, *chili_agc_en, *rx_en;
Xuint32 *chili_mcu_rx_ready, *chili_num_bytes_ready;
// tx registers
...
int Chilipepper_Initialize( void )
{
    ...
    // RX core
    chili_rssi = 			(Xuint32 *)(0x72400000 + 0x800); // read
    chili_percent_full = 	(Xuint32 *)(0x72400000 + 0x804); // read
    chili_dir = 			(Xuint32 *)(0x72400000 + 0x808); // read
    chili_num_bytes_ready = (Xuint32 *)(0x72400000 + 0x80C); // read
    chili_rssi_high_goal = 	(Xuint32 *)(0x72400000 + 0x800); // write
    chili_rssi_low_goal = 	(Xuint32 *)(0x72400000 + 0x804); // write
    chili_agc_en = 			(Xuint32 *)(0x72400000 + 0x808); // write
    rx_en =  				(Xuint32 *)(0x72400000 + 0x80C); // write
    chili_mcu_rx_ready = 	(Xuint32 *)(0x72400000 + 0x810); // write
    // tx core
