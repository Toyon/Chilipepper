 ...
 this_block.addSimulinkInport('mcu_rx_ready_in');
 ...
 this_block.addSimulinkOutport('byte_out');
 byte_out_obj = this_block.port('byte_out');
 byte_out_obj.setType('UFix_8_0');
 this_block.addSimulinkOutport('en_out');
 en_out_obj = this_block.port('en_out');
 en_out_obj.setType('UFix_1_0');
 this_block.port('en_out').useHDLVector(false);
 this_block.addSimulinkOutport('clear_fifo_out');
 clear_fifo_out_obj = this_block.port('clear_fifo_out');
 clear_fifo_out_obj.setType('UFix_1_0');
 this_block.port('clear_fifo_out').useHDLVector(false);
 this_block.addSimulinkOutport('num_bytes_ready_out');
 num_bytes_ready_out_obj = this_block.port('num_bytes_ready_out');
 num_bytes_ready_out_obj.setType('UFix_9_0');
 ...
 this_block.addSimulinkOutport('s_p_out');
 s_p_out_obj = this_block.port('s_p_out');
 s_p_out_obj.setType('Fix_2_0');
 this_block.addSimulinkOutport('s_o_out');
 s_o_out_obj = this_block.port('s_o_out');
 s_o_out_obj.setType('UFix_12_0');
 this_block.addSimulinkOutport('fe_out');
 fe_out_obj = this_block.port('fe_out');
 fe_out_obj.setType('Fix_2_0');
 ...
 if (this_block.inputTypesKnown)
	 ...
	 if(this_block.port('mcu_rx_ready_in').width ~= 1)
		 this_block.setError('Input data type for port "mcu_rx_ready_in" must have width = 1.');
	 end
	 this_block.port('mcu_rx_ready_in').useHDLVector(false);
 end
 ...
 %s Add HDL files
 this_block.addFile('T:\mathworks\TutorialProjects\QPSK_Radio\MATLAB\codegen\qpsk_rx\hdlsrc\qpsk_rx_FixPt_pkg.vhd');
 this_block.addFile('T:\mathworks\TutorialProjects\QPSK_Radio\MATLAB\codegen\qpsk_rx\hdlsrc\qpsk_rx_FixPt.vhd');
% ------------------------------------------------------------
