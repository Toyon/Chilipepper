-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\D-Money\Desktop\Xilinx_stuff\GIT\Chilipepper_Labs\ChilipepperSupport\FIFO_demo\MATLAB\codegen\rx_fifo\hdlsrc\rx_fifo_pcore_addr_decoder.vhd
...
BEGIN
  ...
  decode_rd_empty <= decode_rd_byte_ready WHEN decode_sel_empty = '0' ELSE
      data_in_empty;
  ...
  decode_sel_get_byte <= '1' WHEN addr_sel_unsigned = 66 ELSE
      '0';
