...
#define  get_byte_Data_tx_fifo_pcore          0x10C  //data register for port get_byte
#define  bytes_available_Data_tx_fifo_pcore   0x110  //data register for port bytes_available
#define  byte_received_Data_tx_fifo_pcore     0x114  //data register for port byte_received
#define  empty_Data_tx_fifo_pcore             0x118  //data register for port empty
