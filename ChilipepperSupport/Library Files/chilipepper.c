...
int Chilipepper_Initialize(void) {
	...
	dac_en = (Xuint32 *) XPAR_DAC_DRIVER_AXIW_0_MEMMAP_DAC_EN;
#endif
	...
	chili_rssi = (Xuint32 *) XPAR_DC_OFFSET_AXIW_0_MEMMAP_RSSI; // read
	chili_dir = (Xuint32 *) XPAR_DC_OFFSET_AXIW_0_MEMMAP_DIR; // read
	chili_rssi_high_goal = (Xuint32 *) XPAR_DC_OFFSET_AXIW_0_MEMMAP_RSSI_HIGH_GOAL; // write
	chili_rssi_low_goal = (Xuint32 *) XPAR_DC_OFFSET_AXIW_0_MEMMAP_RSSI_LOW_GOAL; // write
	chili_agc_en = (Xuint32 *) XPAR_DC_OFFSET_AXIW_0_MEMMAP_AGC_EN; // write
	rx_en = (Xuint32 *) XPAR_DC_OFFSET_AXIW_0_MEMMAP_RX_EN; // write
#endif
